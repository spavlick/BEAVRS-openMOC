...
geometry = 'pwru160c00' # raw_input('What is/are the file names? (Enter each one separated by a space without \'c4.\' or the file extension.) ')
...
lattice = Lattice(id=4, width_x=0.62992*2, width_y=0.62992*2)
...
filename = geometry + '-cell_data.hdf5'

f = h5py.File(directory1 + filename, 'r')

lattice_universes = f['cell_types'][...]
lattice_universes[8,8] = 2
